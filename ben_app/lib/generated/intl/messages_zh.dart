...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "enable_password_options_auto_detect" : MessageLookupByLibrary.simpleMessage("自动检测加密设置"),
    "enable_password_options_auto_detect_description" : MessageLookupByLibrary.simpleMessage("开启后，系统会尝试根据您的设备计算出（比默认更强的）达到要求的安全设置。如果不开启系统将会使用推荐的默认设置。"),
    "get_started" : MessageLookupByLibrary.simpleMessage("开始使用"),
    "know_more_security_details" : MessageLookupByLibrary.simpleMessage("Learn more about security details"),
    ...
    "password_does_not_match" : MessageLookupByLibrary.simpleMessage("两次输入的密码不一致"),
    "password_too_short" : MessageLookupByLibrary.simpleMessage("密码长度不符合要求"),
    "please_input_password" : MessageLookupByLibrary.simpleMessage("请输入密码"),
    "please_input_password_again" : MessageLookupByLibrary.simpleMessage("请再次确认密码"),
